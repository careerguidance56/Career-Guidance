...
from CareerGuidanceApp.models import Add_course, Feedback, HRTable, Job_applied_users, LoginTable, Manage_Job, Result, Take_quiz, Upload_resume, UserTable, add_certificate, enroll_course, view_and_enroll_course

# Register your models here.
admin.site.register(LoginTable),
admin.site.register(UserTable),
admin.site.register(HRTable),
admin.site.register(Manage_Job),
